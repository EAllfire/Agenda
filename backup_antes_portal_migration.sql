...
--
-- Table structure for table `agenda_citas`
--
...
--
-- Dumping data for table `agenda_estado_cita`
--

LOCK TABLES `agenda_estado_cita` WRITE;
/*!40000 ALTER TABLE `agenda_estado_cita` DISABLE KEYS */;
INSERT INTO `agenda_estado_cita` VALUES (1,'reservado'),(2,'confirmado'),(3,'asistió'),(4,'no asistió'),(5,'pendiente'),(6,'en espera');
/*!40000 ALTER TABLE `agenda_estado_cita` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `agenda_mensajes`
--

DROP TABLE IF EXISTS `agenda_mensajes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `agenda_mensajes` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `cita_id` (`cita_id`),
  CONSTRAINT `agenda_mensajes_ibfk_1` FOREIGN KEY (`cita_id`) REFERENCES `agenda_citas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `agenda_mensajes`
--

LOCK TABLES `agenda_mensajes` WRITE;
/*!40000 ALTER TABLE `agenda_mensajes` DISABLE KEYS */;
/*!40000 ALTER TABLE `agenda_mensajes` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `agenda_modalidades`
--

DROP TABLE IF EXISTS `agenda_modalidades`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `agenda_modalidades`
--

LOCK TABLES `agenda_modalidades` WRITE;
/*!40000 ALTER TABLE `agenda_modalidades` DISABLE KEYS */;
INSERT INTO `agenda_modalidades` VALUES (1,'Radiología'),(2,'Mastografía'),(3,'Ultrasonido'),(4,'Tomografía'),(5,'Resonancia Magnética'),(6,'Laboratorio');
/*!40000 ALTER TABLE `agenda_modalidades` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `agenda_paquetes`
--

DROP TABLE IF EXISTS `agenda_paquetes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `agenda_profesionales`
--

LOCK TABLES `agenda_profesionales` WRITE;
/*!40000 ALTER TABLE `agenda_profesionales` DISABLE KEYS */;
INSERT INTO `agenda_profesionales` VALUES (1,'Dr. Ramírez'),(2,'Dra. González'),(3,'Dr. Pérez');
/*!40000 ALTER TABLE `agenda_profesionales` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `agenda_usuarios` VALUES (5,'Administrador','admin','admin@hospital.com','$2y$10$3tDRa8FCBq77uIaBdTtwM.qsat/pdjvwDR4OF56Kd3RKdluBt8Gz6','admin',1),(6,'Sandra','sandra','sandra@gmail.com','$2y$10$2dgUZ/S3QBhYWUJSUEQdR.ZKpwopaMqZvizZRbkIRjJBMPxCnR/s6','admin',1),(7,'Eli','eli','eli@gmail.com','$2y$10$NuxX0FKhFh92OahazyuqVOyTpcVw3z1Y38JY/Itajn8NQ5ty5kk2u','caja',1);
/*!40000 ALTER TABLE `agenda_usuarios` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `agenda_ventas_servicios`
--

DROP TABLE IF EXISTS `agenda_ventas_servicios`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `agenda_ventas_servicios` (
  ...
  KEY `servicio_id` (`servicio_id`),
  KEY `cita_id` (`cita_id`),
  CONSTRAINT `agenda_ventas_servicios_ibfk_1` FOREIGN KEY (`paciente_id`) REFERENCES `portal_pacientes` (`id`),
  CONSTRAINT `agenda_ventas_servicios_ibfk_2` FOREIGN KEY (`servicio_id`) REFERENCES `portal_servicios` (`id`),
  CONSTRAINT `agenda_ventas_servicios_ibfk_3` FOREIGN KEY (`cita_id`) REFERENCES `agenda_citas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `agenda_ventas_servicios`
--

LOCK TABLES `agenda_ventas_servicios` WRITE;
/*!40000 ALTER TABLE `agenda_ventas_servicios` DISABLE KEYS */;
/*!40000 ALTER TABLE `agenda_ventas_servicios` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `portal_pacientes`
--

DROP TABLE IF EXISTS `portal_pacientes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `portal_pacientes`
--

LOCK TABLES `portal_pacientes` WRITE;
/*!40000 ALTER TABLE `portal_pacientes` DISABLE KEYS */;
INSERT INTO `portal_pacientes` VALUES (1,'Tito','Pérez','625118881','titoperez@gmail.com','Fractura de tobillo','PENSIONES','urgencias','Paciente con antecedentes de fractura previa.','2025-09-19 16:06:35'),(2,'Fernando','Pérez','625118881','fersperez@gmail.com','Fractura de tobillo','ISSSTE','urgencias','Paciente con antecedentes de fractura previa.','2025-09-19 16:22:47'),(3,'Ricardo','Pérez','625118881','juanperez@gmail.com','Fractura de tobillo','PARTICULAR','urgencias','Paciente con antecedentes de fractura previa.','2025-09-23 19:18:37'),(4,'Abisasi','Ordonez','62525256356','abi@gmail.com','Homeopata','IMSS','externo','lkadfvhaej','2025-09-26 02:41:36'),(5,'Pedro','Morales Perez','6255255121761267','pedro@gmail.com',NULL,'cliente','web','Fecha nacimiento: 2025-09-03 | rsfgwrtgwrtgwrgw','2025-09-26 21:53:37'),(6,'Aron','Perez Rodriguez','6252242422','aron@gmail.com',NULL,'cliente','web','Fecha nacimiento: 1975-01-17 | wEFAwefwaEF','2025-09-26 22:08:02'),(7,'Svein','Flores','6251562675','svein@gmail.com',NULL,'cliente','web','Fecha nacimiento: 1996-12-31','2025-09-30 19:10:20'),(8,'Valeria','','62555255252','valeria99@hotmail.com',NULL,'cliente','web','Fecha nacimiento: 2024-08-08 | kguwefgiuqrgiuargiu','2025-10-02 04:59:02');
/*!40000 ALTER TABLE `portal_pacientes` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `portal_servicios`
--
...
-- Dump completed on 2025-10-07 21:29:21
